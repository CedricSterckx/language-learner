...
const vocabularyUnits = [
	{ id: "voc_1", name: "Unit 1", description: "Countries and Jobs" },
	{ id: "voc_2", name: "Unit 2", description: "Countries and Jobs" },
];
				...
				<div className="grid gap-4 md:grid-cols-2">
					{vocabularyUnits.map((unit) => (
						<Link key={unit.id} to="/flashcards" search={{ unit: unit.id }}>
							<Button variant="outline" className="w-full h-24 flex flex-col items-center justify-center space-y-2 hover:shadow-md transition-shadow">
